...
//        this.passwordEncoder = passwordEncoder;
    ...
    @Override
    public UserResponseDto registerUser(UserRegisterDto dto, String roleName) throws PortfolioException {
        ...
        if (userRepository.existsByEmail(dto.getEmail())) {
            throw new PortfolioException("Email already exists !");
        }
        ...
        newUser.setPasswordHash(dto.getPassword()); // encode later
